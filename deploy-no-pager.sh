...
# Este archivo es una variante de deploy.sh.
# AWS CLI a veces envía la salida a un paginador como "less".
# Cuando eso pasa, el comando queda esperando que presiones "q"
# para cerrar la vista y continuar con el siguiente despliegue.
# Con AWS_PAGER="" desactivamos ese comportamiento para que el
# script avance de forma continua entre una Lambda y la siguiente.
